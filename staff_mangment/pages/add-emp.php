...
include('../config/DbFunction.php');
	...
	if(isset($_POST['submit'])){
     ...
     $obj->emp_register($_POST['course-short'],$_POST['c-full'],$_POST['fname'],$_POST['gname'],$_POST['gender'],$_POST['category'],$_POST['mobno'],$_POST['email'],$_POST['country'],$_POST['state'],$_POST['city'],$_POST['padd'],
 ...
 <input class="form-control" name="c-full"  id="c-full" >
	...
	<br><br>		
			...
			<input class="form-control" name="fname" required="required" pattern="[A-Za-z]+$">
			 ...
			 <div class="col-lg-2">
			<label>Upload Image<span id="" style="font-size:11px;color:red">*</span>	</label>
			</div>
			<div class="col-lg-4">
