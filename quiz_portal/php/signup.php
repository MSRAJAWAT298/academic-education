   ...
   <tr>
     <td><form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
       <table width="301" border="0" align="left">
         ...
         <tr>
           <td class="style7">Father's Name</td>
           <td><input name="fname" type="text" id="fname"></td>
         </tr>
         
         <tr>
           <td class="style7">Qualification</td>
           <td><input name="edu_quali" type="text" id="edu_quali"></td>
         </tr>
         
         <tr>
           <td class="style7">School/College/University</td>
           <td><input name="scuniv" type="text" id="scuniv"></td>
         </tr>
         
         <tr>
           <td class="style7">D.O.B.</td>
        ...
        <!-- <tr>
           <td class="style7">Study Centre Name</td>
           <td><input name="acname" type="text" id="acname"></td>
         </tr>
         
         <tr>
           <td class="style7">Centre ID</td>
           <td><input name="centid" type="text" id="centid"></td>
         </tr>
         -->
         <tr>
           <td class="style7">I Agreed</td>
           <td><input name="agree" type="checkbox" id="agree" value="I Agreed"> : I Agreed</td>
         </tr>
