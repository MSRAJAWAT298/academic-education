...
if(isset($submit))
{
	...
	$rs=mysql_query("select * from mst_admin where loginid='$loginid' and pass='$pass' and center_code='$ccode'",$cn) or die(mysql_error());
...
<p class="head1">
Welcome to <font color="blue" size="+3">"<?php echo $loginid?>"</font> 
